...
public abstract class TransactionType {
    ...
    public static abstract class ColoredCoins extends TransactionType {
        ...
        public static final TransactionType ASSET_INCREASE = new ColoredCoins() {
            ...
            public Fee getBaselineFee(Transaction transaction) {
                return new Fee.ConstantFee(Fee.MIN_FEE * 10);
            }
        ...
        public static final TransactionType ASSET_PROPERTY_SET = new ColoredCoinsAssetPropertyTransactionType() {
            ...
            private final Fee ASSET_PROPERTY_FEE = new Fee.SizeBasedFee(Fee.MIN_FEE, Fee.MIN_FEE, 32) {
                @Override
                public int getSize(TransactionImpl transaction, Appendix appendage) {
    ...
    public static abstract class AccountControl extends TransactionType {
        ...
        public static final TransactionType SET_PHASING_ONLY = new AccountControl() {
            ...
            void validateAttachment(Transaction transaction) throws ValidationException {
                ...
                long maxFeesLimit = (attachment.getPhasingParams().getVoteWeighting().isBalanceIndependent() ? 3 : 22) * Fee.MIN_FEE;
                if (maxFees < 0 || (maxFees > 0 && maxFees < maxFeesLimit) || maxFees > Constants.MAX_BALANCE_NQT) {
                    throw new NxtException.NotValidException(String.format("Invalid max fees %f %s", ((double)maxFees)/Fee.MIN_FEE, Constants.COIN_SYMBOL));
                }
    ...
    public static abstract class Data extends TransactionType {
        ...
        private static final Fee TAGGED_DATA_FEE = new Fee.SizeBasedFee(Fee.MIN_FEE, Fee.MIN_FEE/10) {
            @Override
