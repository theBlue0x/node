...
const options = {
    url: "http://localhost:6876", // URL of remote node
...
exports.load = function(callback) {
    ...
    require("jsdom").env("", function(err, window) {
        try {
            ...
            // the client wasn't designed with modularity in mind therefore we need
            ...
            // Now load some specific libraries into the global scope
