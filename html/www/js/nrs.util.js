...
var NRS = (function (NRS, $, undefined) {
    ...
    NRS.getAccountMask = function(c) {
        switch(c) {
            ...
            default:
                return NRS.constants.ACCOUNT_MASK_PREFIX ? NRS.constants.ACCOUNT_MASK_PREFIX : "BLX-";
        }
    };

    NRS.printPaperWallet = function(passphrase) {
        var $pageHeader = $("<h2 data-i18n='nxt_ardor_paper_wallet'>Blue0x Paper Wallet</h2>");
